#
#  Be sure to run `pod spec lint TGPEliza.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   Eliza, the 1966 Chat robot

                   DESC

  s.homepage     = "https://github.com/arquebuse/TGPEliza"
  ...
  s.source       = { :git => "https://github.com/arquebuse/TGPEliza.git", :tag => "0.0.3" }
